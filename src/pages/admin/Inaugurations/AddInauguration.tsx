...
export default function AddInauguration() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert('Add Inauguration functionality will be implemented with backend API');
                ...
                <div className="row">
                  ...
                  <div className="col-md-4">
                    <div className="form-group">
                      ...
                      >
                        <option value="" disabled selected>Please Select Deparment</option>
