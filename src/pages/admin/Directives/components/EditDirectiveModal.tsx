/**
 * Edit Directive Modal Component
 * Inline edit modal from directives list page
 */

import { useState, useEffect } from 'react';

interface EditDirectiveModalProps {
  isOpen: boolean;
  onClose: () => void;
  directive: any;
...
export function EditDirectiveModal({ isOpen, onClose, directive, onSubmit }: EditDirectiveModalProps) {
