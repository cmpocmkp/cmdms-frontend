 ...
 * EXACT replica of admin/report/department-wise/cabinet-meeting/decisions
 */
...
export default function CabinetDepartmentWiseReport() {
  ...
  useEffect(() => {
    ...
    //   try {
    //     const response = await api.get('/admin/report/department-wise/cabinet-meeting/decisions');
    ...
    <div className="content-wrapper">
      <div className="card">
        <div className="card-body">
          <center>
            <h3>Cabinet Department-wise Report</h3>
