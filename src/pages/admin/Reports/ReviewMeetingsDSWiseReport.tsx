 ...
 * EXACT replica of admin/report/review-meetings/ds-wise.blade.php
 */
...
export default function ReviewMeetingsDSWiseReport() {
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    //   const response = await api.get(`/admin/report/ds-wise-review-meetings?${params.toString()}`);
    ...
    <div className="content-wrapper">
      <div className="card">
        <div className="card-body">
          <h4 className="card-title text-primary text-center">Review Meetings By DS</h4>
