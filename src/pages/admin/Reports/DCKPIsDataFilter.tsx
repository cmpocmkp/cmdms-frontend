/**
 * DC KPIs Data Filter
 * EXACT replica of admin/kpi/data/show.blade.php from old CMDMS
 */
  ...
  return (
    <div className="content-wrapper">
      <div className="col-md-12 grid-margin stretch-card">
        <div className="card">
          <span className="ml-4 mt-3">DCs Reports</span>
          <div className="row">
                    ...
                    dateGroups.forEach((dateWise, date) => {
                      ...
                      rows.push(
                        <tr key={`${userId}-${date}`}>
                          ...
                          {/* KPI Columns */}
                          {dcKpiColumns.map((dcKpiColumn) => {
                            // Find matching entry for this column (avoid duplicates)
