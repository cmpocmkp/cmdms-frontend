/**
 * Add Candidate Request - Admin Module
 * EXACT replica of admin/candidaterequests/add.blade.php from old CMDMS
 */
...
import { candidateRequestStatuses } from '../../../lib/mocks/data/candidateRequests';
...
export default function AddCandidateRequest() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert('Add Candidate Request functionality will be implemented with backend API');
  };
        ...
        <div className="col-12 grid-margin stretch-card">
          <div className="card">
            <div className="card-body">
              ...
              <p className="card-title"><strong>Add new candidate request</strong></p>
                    ...
                    <div className="form-group">
                      ...
                      >
                        ...
                        {mockOfficers.map((officer) => (
                          <option key={officer.id} value={officer.id.toString()}>
